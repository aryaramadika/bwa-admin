            ...
            <div className="row">
                <div className="col-lg-4 text-lg-start text-center">
                    <a href="" className="mb-30">
                        ...
                        <Image src="/icon/fisioterapilogo-1.svg" width={160} height={60} />
                    </a>
                    <p className="mt-30 text-lg color-palette-1 mb-30">Open on : <br/> Morning 08.00 Wita -12.00 Wita <br/> Evening 17.00 Wita -21.00 Wita</p>
                    ...
                    <div className="row gap-sm-0">
                        ...
                        <div className="col-md-4 col-12 mt-lg-0 mt-md-0 mt-25">
                            ...
                            <ul className="list-unstyled">
                                ...
                                <li className="mb-6">
                                    <a href="https://goo.gl/maps/qHy2tEhYGiLih22E9"
                                     className="text-lg color-palette-1 text-decoration-none">Jl. Tukad banyusari no. 5 
                                    Panjer,
                                        Denpasar , Bali</a>
                                </li>
                                <li className="mb-6">
                                    <a href="tel: 0361245245"
                                        className="text-lg color-palette-1 text-decoration-none">0361-245245</a>
                                </li>
                            </ul>
                        </div>
                    </div>
