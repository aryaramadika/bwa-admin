                    ...
                    <section className="checkout mx-auto">
                        ...
                        <div className="purchase pt-30">
                            ...
                            <Row label='Item ' value='250
                                    Diamonds'/>
                            <Row label='Price ' value='Rp
                                    42.280.500'/>
                            <Row label='Tax (10%) ' value='#Rp
                                    4.228.000'/>
                            <Row label='Total ' value='Rp
                                    55.000.600' className ='color-palette-4'/>
                        </div>
                        <div className="payment pt-10 pb-10">
                            <h2 className="fw-bold text-xl color-palette-1 mb-20">Payment Informations</h2>
                            <Row label='Your Account Name ' value='Masayoshi
                                    Angga Zero'/>
                            <Row label='Type ' value='>Worldwide
                                    Transfer'/>
