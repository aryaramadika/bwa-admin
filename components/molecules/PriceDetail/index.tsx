...
export default function PriceDetail(props:PriceDetaiProps) {
    const{
        treatmenType,
        price,
        _id,
    ...
    // console.log(treatmenType,price,_id)
    return (  
         <label 
            ...
            onChange={onChange}
               >
                <input className="d-none" type="radio" id={_id} name="priceDetail" value={_id}/>
